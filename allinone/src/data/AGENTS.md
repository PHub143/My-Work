...
| `learningTracks.js` | Tiny title/subtitle/questionCount metadata for the LearningHome cards, so that screen doesn't import the multi-MB `ai10xContent.json` banks. Keep counts in sync with those files. |
